...
function getServiceDefinitionsFromStorage({ graphId, apiKeyHash, graphVariant, federationVersion, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (linkFileCacheHit)
            return [serviceDefinitionList, false];
        ...
        const parsedConfig = JSON.parse(configFileResult);
...
function fetchPartialSchemaFiles(implementingServices) {
    return __awaiter(this, void 0, void 0, function* () {
        let isDirty = false;
        const fetchPartialSchemasPromises = implementingServices.map(({ name, path }) => __awaiter(this, void 0, void 0, function* () {
            ...
            const { isCacheHit, result } = yield fetcher.fetch(`${urlPartialSchemaBase}/${partialSchemaPath}`);
            if (!isCacheHit) {
                isDirty = true;
            }
            return { name, url, typeDefs: graphql_1.parse(result) };
        }));
        const services = yield Promise.all(fetchPartialSchemasPromises);
